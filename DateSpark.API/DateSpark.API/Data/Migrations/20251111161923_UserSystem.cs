    ...
    public partial class UserSystem : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCouples", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserCouples_Couples_CoupleId",
                        column: x => x.CoupleId,
                        principalTable: "Couples",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserCouples_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Couples_JoinCode",
                table: "Couples",
                column: "JoinCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserCouples_CoupleId",
                table: "UserCouples",
                column: "CoupleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserCouples_UserId_CoupleId",
                table: "UserCouples",
                columns: new[] { "UserId", "CoupleId" },
                unique: true);
